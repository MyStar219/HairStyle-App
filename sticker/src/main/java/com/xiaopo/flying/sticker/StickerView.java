...
//                            mHandlingSticker.getMatrix().reset();
    ...
    public void addSticker(Bitmap stickerBitmap, int ips) {
   /* if(mStickers.isEmpty()){
        ...
        if (ips == 2) {
            if (mStickers.isEmpty()) {
                yes = 0;
                tree = true;
                addSticker(new BitmapDrawable(getResources(), stickerBitmap), yes);
            ...
            if (mStickers.isEmpty()) {
                yeson = 0;
                tree = false;
                addSticker(new BitmapDrawable(getResources(), stickerBitmap), yeson);
    ...
    public void addSticker(Drawable stickerDrawable, int no) {
        ...
        if (no == 0) {
            ...
            mStickers.add(no, drawableSticker);
            ...
            if (tree) {
                ...
                if (mStickers.size() == 1) {
                    mStickers.remove(0);
                    mStickers.add(0, drawableSticker);
                ...
                if (mStickers.size() == 2) {
                    mStickers.remove(1);
                    mStickers.add(1, drawableSticker);
